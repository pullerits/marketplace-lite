            ...
            <nav className="hidden md:flex space-x-6">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="text-foreground hover:text-etsy-orange flex items-center gap-1">
                    Categories
                    <ChevronDown className="h-4 w-4" />
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent className="w-56 bg-background border border-border shadow-lg">
                  <DropdownMenuItem asChild className="hover:bg-accent hover:text-accent-foreground cursor-pointer">
                    <Link href="/draft/produce">Produce</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild className="hover:bg-accent hover:text-accent-foreground cursor-pointer">
                    <Link href="/draft/meat-poultry">Meat & Poultry</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild className="hover:bg-accent hover:text-accent-foreground cursor-pointer">
                    <Link href="/draft/seafood">Seafood</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild className="hover:bg-accent hover:text-accent-foreground cursor-pointer">
                    <Link href="/draft/dairy-eggs">Dairy & Eggs</Link>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem asChild className="hover:bg-accent hover:text-accent-foreground cursor-pointer">
                    <Link href="/draft/pantry">Pantry</Link>
                  </DropdownMenuItem>
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem asChild className="hover:bg-accent hover:text-accent-foreground cursor-pointer">
                    <Link href="/draft/plants-flowers">Plants & Flowers</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild className="hover:bg-accent hover:text-accent-foreground cursor-pointer">
                    <Link href="/draft/crafts-art">Crafts & Art</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="hover:bg-accent hover:text-accent-foreground cursor-pointer">
                    Health & Beauty
                  </DropdownMenuItem>
